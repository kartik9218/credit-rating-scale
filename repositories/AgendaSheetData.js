  ...
  return new Promise(async (resolve, reject) => {
    ...
    const rating_committee_meeting = await RatingCommitteeMeeting.findOne({
      ...
      const rating_sheet_data = await DB_CLIENT.query(`
        SELECT DISTINCT c.name AS entity_name, c.cin AS company_cin, ic.category_name AS instrument, m.total_size AS size_in_crore, rp.name AS nature_of_assignment, rcm.id AS rating_committee_meeting_id, rcm.meeting_at AS meeting_at FROM  rating_committee_meeting_registers rcmr 
